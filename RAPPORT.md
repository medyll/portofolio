...
- **Techno recommandée pour le portfolio : SvelteKit + `adapter-static` + `@medyll/css-base`, déployé sur GitHub Pages.**
  - C'est ta stack maîtrisée, ton propre design system, zéro serveur, hébergement GitHub gratuit.
...
| Critère | Verdict |
|---|---|
| Maîtrise | Svelte 5 partout dans tes repos (idae, sive, latent-line, dash-git…) |
| Design system | `@medyll/css-base` est à toi → cohérence visuelle gratuite |
...
- `@medyll/css-base` pour les tokens/layout
...
- **css-base** (`@medyll/css-base`) — Design system CSS moderne, sans build, features CSS de pointe. Ton propre DS — sert aussi de socle visuel au portfolio.
...
3. Scaffolder le site SvelteKit + `@medyll/css-base` + workflow GitHub Pages.
